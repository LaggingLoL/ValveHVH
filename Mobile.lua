...
local Window = library:CreateWindow("Valve V1.0.0 | Mobile Version", Vector2.new(492, 592), Enum.KeyCode.M) 
...
local RageSec = RageTab:CreateSector("Rage", "left")
...
local SpeedBindxd = RageSec:AddToggle("Speed", false, function(parameter)
...
RageSec:AddSlider("Speed Amount", 1,1,5000,10, function(State)
